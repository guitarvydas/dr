...
prep "." "$" designrule.ohm designrulea.glue --stop=1 --support=${cwd}/support.js --PLPATH=${plpath} <$temp >a-$fname
prep "." "$" designrule.ohm designruleb.glue --stop=1 --support=${cwd}/support.js --PLPATH=${plpath} <dr-edgecontainment.md >b-$fname
rm $temp
